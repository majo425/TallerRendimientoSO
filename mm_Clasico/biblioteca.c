/**************************************************************
	...
	Fichero: Cuerpo de las funciones para la multiplicación de matrices.
...
void final_tiempo(){
	...
	stop.tv_sec -= start.tv_sec; // Calcula la diferencia del tiempo actual con el tiempo inicial
...
void *mult_thread(void *variables){
	...
	int nH  = data->nH; // Asigna el número de hilo
	int N   = data->N; // Asigna el tamaño de la matriz NxN
	int ini = (N/nH)*idH; // Calcula el índice inicial para la sección de la matriz a procesar por el hilo actual
	int fin = (N/nH)*(idH+1); // Calcula el índice final para la sección de la matriz a procesar por el hilo actual
